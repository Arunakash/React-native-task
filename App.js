...
//         <View style={[styles.container],{height:'100%',width:devicewidth,backgroundColor:'black'}}>
         
//         <View style={{alignSelf:'stretch',marginTop:40,height:'95%'}}>
...
//          </TouchableHighlight>      
//           </View>
//           <TouchableHighlight style={styles.btmView}>
